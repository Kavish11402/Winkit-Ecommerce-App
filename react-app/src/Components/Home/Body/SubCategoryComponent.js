export default function SubCategoryComponent({productImage, productDescription, productQuantity, productPrice })
{
    ...
    return(
        <div className={"border-2 bg-white border-gray-300 rounded-lg hover:border-wGreen hover:drop-shadow-2xl transition-all w-48 px-3 pb-3 mx-10"}>
            ...
            <div>
                ...
                <img src={productImage} className={"h-36 mx-auto"} alt={"Product Image"}/>
